...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public static int mytap { get; private set; }
        ...
        {
            var tup = (1, 3);
            ValueTuple<int, string, char, string, ushort>student = (123, "sdfsg", 'x', "four", 123);
            (int first, string second, char third, string fourth, ulong fivth) mytap = (123, "sdfsg", 'x', "four", 123);
